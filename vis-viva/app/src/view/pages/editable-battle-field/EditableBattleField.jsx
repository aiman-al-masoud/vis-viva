    ...
    render() {
        return (<div style={{ backgroundImage: `url(${BackgroundImage})`, backgroundSize: "cover" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto" }} >
                <h1 style={{fontFamily:'"Samurai", Arial'}}>{L.field_your_troops}</h1>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto" }} >
                ...
                <BattleUnitsSelector selectedType={this.state.selectedBattleUnitType} getIcon={BattleUnitFactory.getIconFor} types={BattleUnitFactory.getTypes()} selectType={this.selectBattleUnitType}   getTypeStats={ (type)=>{ return BattleUnitFactory.new(type).getStats()  }}  getDescription={BattleUnitFactory.getDescriptionFor}   />
            </div>
